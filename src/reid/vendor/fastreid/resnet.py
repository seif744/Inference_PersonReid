...
# NOTE: fastreid's build_resnet_backbone(cfg) was removed when vendoring --
# it reads a yacs config and fetches ImageNet pretrain weights, neither of which
# applies here. FastReIDBackend constructs ResNet(...) directly instead.
